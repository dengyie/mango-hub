...
// 经度 -15° → 视点中心东经 15°:全球覆盖最优的平衡视角。
// 初始可见:南美(11/12)+北美+欧洲(6/6)+非洲(4/4)+中国/印度/东南亚,覆盖全部活跃节点国家;
// 日本/韩国/澳洲/新西兰在自转 ~6 秒内转入视野(经度差 ~40°)。
// 对比历史:旧 -10°(面向大西洋)用户反馈"缺日本/澳洲"、-120°(面向亚太)导致南美整块消失 35 秒,
// -15° 让两侧盲区最小且快速补位,任何大洲都不会长时间缺失。
const INITIAL_ROTATION_LAMBDA = -15;
